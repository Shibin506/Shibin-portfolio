        ...
        >
          {educationList.map((edu, idx) => (
            <motion.div 
              ...
              className="card hover-lift border border-gray-300 dark:border-gray-700/50 p-6 sm:p-8 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-lg"
            >
